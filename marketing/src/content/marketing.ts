...
/**
 * Auth (sign-in / create-venue) lives in the separate app deployment. Set
 * NEXT_PUBLIC_APP_URL to its origin — e.g. https://app.reservme.pro — so these
 * CTAs point there. `?new=1` opens the create-venue tab. Until the app is
 * deployed these links won't resolve yet; that's expected for a marketing-first
 * launch.
 */
